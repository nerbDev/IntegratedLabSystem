                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="contact_person" class="form-control"
                                       value="{{ old('contact_person', $staff->contact_person) }}">
                            </div>
                            <div class="col-md-6">
        ...
        <div class="col-md-4">
            <div class="card glass-card mb-4">
                <div class="card-body text-center">
                    ...
                    <span class="badge-role">{{ strtoupper($staff->role) }}</span>

                    <hr>

                    <div class="info-row">
                        <span class="label">Account Created</span>
                        <span class="value">{{ $staff->created_at->format('M d, Y') }}</span>
                    </div>
                    <div class="info-row">
                        <span class="label">Last Updated</span>
                        <span class="value">{{ $staff->updated_at->format('M d, Y h:i A') }}</span>
                    </div>

                    @if($staff->oauth_provider)
                        <div class="mt-3">
                            <span class="oauth-badge">
                                <i class="bi bi-shield-check text-info"></i>
                                Signed in via {{ ucfirst($staff->oauth_provider) }}
                            </span>
                        </div>
                    @endif
                </div>
