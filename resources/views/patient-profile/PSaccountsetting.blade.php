...
<style>
    ...
    .profile-page input.form-control[readonly] {
    ...
    <div class="row">
        ...
        <div class="col-md-8 mb-4">
            <div class="card glass-card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('patient.accountsetting.update') }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email" class="form-control"
                                       ...
                                       {{ $user->oauth_provider ? 'readonly' : '' }} required>
                                @if($user->oauth_provider)
                                    <small style="color: rgba(255,255,255,0.5);">Managed by your {{ ucfirst($user->oauth_provider) }} sign-in.</small>
                                @endif
                            </div>
                            <div class="col-md-6">
        ...
        <div class="col-md-4">
            <div class="card glass-card mb-4">
                <div class="card-body text-center">
                    ...
                    <div class="info-row">
                        ...
                        <span class="value">{{ $user->updated_at->format('M d, Y h:i A') }}</span>
                    </div>
                    ...
                    @if($user->oauth_provider)
                        <div class="mt-3">
                            <span class="oauth-badge">
                                ...
                                Signed in via {{ ucfirst($user->oauth_provider) }}
                            </span>
                        </div>
                    @endif
                </div>
            ...
            @if(!$user->oauth_provider)
                <div class="card glass-card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('patient.accountsetting.password') }}">
                            @csrf
                            @method('PUT')
